def find_my_coordinates(r, c, mtrx):
    for row in range(r):
        for col in range(c):
            if mtrx[row][col] == "M":
                return [row, col]
...
mouse_coordinates = find_my_coordinates(rows, cols, matrix)
...
#
#     if command == "up":
#         result = check_my_next_position(mouse_coordinates[0] - 1, mouse_coordinates[1], matrix)
#     elif command == "down":
#         result = check_my_next_position(mouse_coordinates[0] + 1, mouse_coordinates[1], matrix)
#     elif command == "left":
#         result = check_my_next_position(mouse_coordinates[0], mouse_coordinates[1] - 1, matrix)
#     elif command == "right":
#         result = check_my_next_position(mouse_coordinates[0], mouse_coordinates[1] + 1, matrix)
#
#     if result:
#         mouse_coordinates, matrix, touches = result
